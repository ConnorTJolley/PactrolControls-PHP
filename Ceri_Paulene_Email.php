    ...
    <main role="main">
      <div class="container marketing">
        ...
        <div>
          ...
          $_SESSION["EmailToUse1"]="ceri.marsh@emerson.com";
          $_SESSION["EmailToUse2"]="paulene.scaldwell@emerson.com";
              
          print_r("<h3>Please use the form below to email Ceri Marsh and Paulene Scaldwell.</h3>");
        
          ?>
         <p>
           
       <form action="submitemail2.php" method="POST">
